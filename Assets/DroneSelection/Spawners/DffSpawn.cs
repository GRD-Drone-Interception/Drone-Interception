...
namespace DroneSelection
{
    ...
    /// </summary>
    public class DffSpawn : MonoBehaviour, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            if (_drone.gameObject.CompareTag("Defender")) // Only allow Defender objects to spawn
            {
